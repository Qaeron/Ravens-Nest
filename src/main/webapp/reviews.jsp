...
<body>
<div class="container">
    <h2>Listen to the throes of despair of the critics (List of Reviews)</h2>

    <div class="container-fluid" style="margin:0 auto; margin-bottom:30px ! important">
        <form class="d-flex" method="post" action="reviews.jsp">
            <input class="form-control me-2" name="searchtext" id="searchtext" type="search" placeholder="Search reviews by their contents" aria-label="Search">
    ...
    <div class="row">
        ...
        <ul class="list-group">
            ...
            <%
                ...
                try {
                    List<Review> reviews = reviewDao.findAll(searchText);
                    for (Review review: reviews) {
            %>
            <li class="list-group-item" style="width: 50% ! important">
                <a target="_blank" href="review.jsp?idreview=<%= review.getIdReview() %>"></a>
